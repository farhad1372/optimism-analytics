<template>
  <div class="row">
    <div calss="col-12">
      <img src="@/assets/images/stake.jpg" style="width: 100%" class="rounded" />
      <h2 class="mt-8">Stake and Unstake </h2>
      <p>
        If you've been in the crypto space for a little while now, you may have heard the term “staking.” You might
        still have some questions around what it means, how it works, the risks <br />
        associated with staking, and which cryptocurrencies offer stalking rewards. Not to worry, in this blog post,
        we
        will go over the basics of staking for you.<br />
        But first, we will start by saying that crypto staking is the process of putting a set amount of
        cryptocurrency
        you already own as collateral to support the verification of blockchain <br />
        transactions. Participants that offer up their crypto are rewarded for doing so.<br />
        Another way to think about it is that participants are incentivized to earn rewards by maintaining the
        integrity
        of the blockchain without a centralized party. While staking is a great way<br />
      ...
      <p>
        ...
        transactions. When you stake crypto, you are essentially putting your crypto up as <br />
        ...
        crypto you earn and the payout interval will depend on the crypto asset<br />
        you stake, the length of time you stake it for, and the networks overall health.<br />
        ...
        mechanism that requires participants to stake coins in order for them to<br />
        be randomly selected as a validator of the network. Because participants have to give up their crypto assets,
        the network is thought to be less susceptible to hacks. After all, participants <br />
        ...
        Proof-of-Work, which we will explain later. For now, keep in mind that PoS keeps <br />
      ...
      <p>
        ...
        cryptocurrencies support staking, so be sure to check that your wallet allows you to <br />
        stake.<br />
        Once you have a compatible wallet, you will need to deposit the cryptocurrency you wish to stake into your
        wallet. If you bought crypto from the Netcoins platform, then youd need to<br />
        withdraw your crypto from Netcoins and deposit them into your wallet.<br />
        Once your crypto is in your wallet and ready to be staked, the actual process of staking will vary depending
        on
        the crypto asset you are staking and the platform you are using and the <br />
        ...
        crypto for one year to receive the maximum amount of rewards. Or, you may<br />
        ...
        Its important to note that crypto staking is not the same as mining. With mining, you use your computers
        processing power to help validate transactions on a blockchain rather than <br />
        offer up existing coins. On the other hand, with staking, you are simply holding crypto in your wallet as
        collateral. You are not using your computers processing power or solving <br />
      ...
      <p>
        ...
        for two months, you might make just 1% to 2%. If you stake a less well-<br />
        known crypto asset like PIVX, you could earn over 6% per year. But you could expose yourself to more
        volatility
        and risk. Thats why its important to do your due diligence on ease of <br />
        staking, reward pay-out, and risks involved.<br />
        Its also important to remember that crypto prices and rewards are volatile and can go up or down at any time.
        A
        safer bet can be staking stablecoins tied to a fiat currency (like the U.S. <br />
      ...
      <p>
        ...
        you cannot sell or trade your crypto while its being staked. If the price of <br />
        ...
        Finally, if the blockchain network you are staking for experiences a hack or an attack, your crypto could be
        at
        risk too[3].<br />
